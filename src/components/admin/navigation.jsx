        ...
        <a href="/dashboardAdmin/home">
          <button
            className={`${bar == 1
              ...
              } w-full h-10 flex my-3 hover:text-[#0d3064] hover:ps-3 hover:bg-white rounded-sm duration-200 ease-in-out`}
          >
            {bar === 0 ? (
              <div className="w-10">
