    ...
    <>
      ...
      <div className="md:grid md:grid-cols-3 gap-4 px-10 ">
        {dataArticle.map((data, i) => {
          ...
          // Combine all content instead of just taking the first one
          const fullContent = data.content
            .map((contentItem) =>
              language == "en" ? contentItem.contentIng : contentItem.contentChi
            )
            .join("");
          ...
          return (
            <div key={i}>
              <CustomCard
                ...
                isi2={fullContent} // Use the combined content instead of just data.content[0]
                id={data.id}
                img={data.img}
              />
            </div>
