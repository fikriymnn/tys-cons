...
function MainCard({ icon, title, text1, text2, text3, text4, text5, text6, text7, clickText1, clickText2, clickText3, clickText4, clickText5, clickText6, clickText7 }) {
     return (
          <Card className='group block rounded-lg md:p-6 md:bg-white bg-blue-600 ring-1 ring-slate-900/5 shadow-lg space-y-3 md:hover:bg-sky-500 hover:ring-sky-500  group-hover:text-white'>
               ...
               <div className="flex items-baseline text-gray-900  first-linexport hover:/assets/images/icontools3.png 
                    ...
                    <span className="border-b-2 border-white md:border-none ml-1 text-xl font-normal my-auto  text-black  group-hover:text-white md:text-white">
                         {title}
                    </span>
