...
function CardTwo({ title, price, text1, text2, text3, text4, text5, text6 }) {
     return (
          <Card>
               ...
               <a className=' className="inline-flex w-full justify-center rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-cyan-200 dark:focus:ring-cyan-900' href="">
                    <p>
                         DETAILS
                    </p>
