        ...
        <div className=' w-full bg-[#031530] '>
            <div className=' md:grid md:grid-cols-3 p-5 sm:p-8 md:p-12 gap-2 items-start'>
                <div className=' mx-auto'>
                    ...
                    <p className=' py-3 text-white text-base leading-normal font-sans'>TYS Consulting is a Business Consultant with main business in providing one-stop enterprise consultation services for enterprises or individuals who wants to establish business in Indonesia.</p>
                </div>
                <div className=' md:ml-2'>
                    <p className=' uppercase font-bold text-white font-sans '>Contact Us</p>
                    <p className=' text-white pt-3 pb-2 font-sans'>Citra garden, Kalideres, Jakarta Barat 11840</p>
                    <div className=' flex gap-3 py-2'>
                        <img src="/assets/images/call (2).png" alt="" className='w-5 h-5 my-auto' />
                        <p className=' text-white my-auto font-sans'>0812-1355-1038</p>
                    </div>
                    <div className=' flex gap-3 py-2'>
                        <img src="/assets/images/email (4).png" alt="" className='w-5 h-5 my-auto' />
                        <p className=' text-white my-auto font-sans'>marketing@.com</p>
                    </div>
                </div>
                <div className=' px-2'>
                    <p className=' text-white font-bold pb-3 font-sans'>Our Social Media</p>
            ...
            <div className=' md:flex lg:justify-between md:p-5 pt-5  text-center'>
                <span className=' text-white font-sans'>Copyright &copy; 2022 tysconsultant.com</span>
                <br />
                <span className=' text-white lg:visible invisible font-sans'>Powered by tysconsultant.com</span>
            </div>
        </div>
    )
}
