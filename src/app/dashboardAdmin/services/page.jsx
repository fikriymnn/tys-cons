...
export default function ServicesAdmin() {
                ...
                <div className="h-[450px] overflow-y-auto flex flex-col gap-3">
                  {[...Array(5)].map((_, i) => (
                    ...
                    >
                      ...
                      {/* Image */}
                      <div className="p-2 w-[209px] border-s-2 flex items-center">
                      ...
                      <div className="w-full flex">
                        ...
                        <div className="w-[250px] border-x-2 flex flex-col justify-center gap-2 p-2">
                          <div className="h-4 bg-gray-400 rounded w-3/4" />
  ...
  return <ServicesAdminPage data={dataService} />;
}
