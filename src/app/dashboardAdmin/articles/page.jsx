...
export default function ArticlesAdmin() {
              ...
              <div className="grid grid-cols-1 gap-5 w-full">
                ...
                <div className="h-[450px] overflow-y-auto flex flex-col gap-3">
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
                      className="flex bg-slate-300 rounded-md animate-pulse"
                    >
                      {/* No */}
                      ...
                      {/* Image */}
                      <div className="px-4 py-2 w-[212px] border-s-2 flex items-center">
  ...
  return <ArticlesAdminPage data={dataArticles} />;
}
